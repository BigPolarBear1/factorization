...
def QS(n,factor_list,sm,flist,quadlist):#,flist,zlist,eq_list):#,sm2,flist2,qchar,z_list,disc_list,quad_base,mod_list):
    global p_amount
...
def find_comb(lists,n,procnum,return_dict,hmap,quad_base,hmap2):
    ...
    test=QS(n,lists,ret_array[0],ret_array[1],ret_array[2])#,ret_array[2],ret_array[6],ret_array[7])   
