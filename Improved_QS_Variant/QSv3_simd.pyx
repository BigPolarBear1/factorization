       ...
       # print(bitlen(local_mod))
        ...
        if local_mod>1:
            ...
            while c < 2:
                ...
                lin,lin_parts=get_lin(hmap,indexmap,cfact,local_mod,indexes,c,n)  
                quad=c
                if quad == 0 or lin == 0:
                    c+=2
                    continue  
...
def find_similar(poly_val,value,seen_primes,cmod,root,n,quad_co,factor_base,qfactor_base,local_factors,hmap,indexmap,quad_interval_index,quad_interval,ret_array,grays,target_main,logmap,size):
    ...
    while quad < 10:
        ...
        while poly_ind < end:
            ...
            size=bound_estimated       
            temp,temp_neg =construct_interval_similar(quad,lin,new_mod,factor_base,hmap,n,indexmap,temp,temp_neg,logmap,size,primes)
