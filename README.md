...
Update: There was a minor mistake in that initial upload... must subtract the squares of the linear coefficients, not just the linear coefficients. The code is super slow. I'm just making the transformations to set it up into something I can properly sieve and reduce to a square finding problem.
