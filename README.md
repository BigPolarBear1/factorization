...
Update: Quickly added a sieve interval to make the PoC a little less crappy. If you run the above command, using a factor base of 10_000 primes, it will succeed at around 3000 B-smooths. Which is less then half.
