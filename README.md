...
Its actually quit simple... and we're actually just stepping back to the PoC we had back in march... I have a bit of a knot in my stomach right now that it took me 9 months to come to these conclusions. I guess I just needed that time to mature a bit more with my math skills... it is what it is... next research project will be faster.

I'll take a break now and go for a run soon. I think later tonight, I'll move generate_modulus inside the loop that iterates quadratic coefficients. And just set it up perfectly so the only thing left to worry about is that final heuristic to get a good root size.

I'll upload a much better version tonight. Thats my goal for tonight.. have the algorithm in its final form... as simplified as can be. With the only thing left to do the heuristic for getting a root of a specific size in generate_modulus(). Then hopefully that I can sort out before the end of the week.... Really huge knot in my stomach.. *sigh* ... this is what I was doing in march lol... I just didn't understand it. I got sidetracked by SIQS because it was faster.. but its not about speed... its about the ability to find smooths past that 110 digit ceiling. Which my approach can as long as I have that heuristic for the size of the root.
