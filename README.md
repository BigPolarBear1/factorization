...
Update: I'll just add a sieve interval to find large squares to reduce the quadratic coefficient with... that should already work fairly well. Can always refactor shit later. Let me get a sieve interval going today.
