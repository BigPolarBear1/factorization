...
Update: Just uploaded a trivial improvement. Sieving using x^2-Nk rather then x^2+Nk .. which is just kind of lame. Next I will add SIQS type improvements to psieve()... because I just realized that there is nothing stopping us from doing that really... that should atleast double the speed... then further optimizations can be made by improving the sieve region to sieve diagonally following the optimal values (b-smooth candidates that are as small as possible as we iterate x and k). There also even more optimizations.. like dividing out squares (multiplying div with squares) .. which will divide linear coefficients in essence... so we can optimize that for a certain sieve region... it really has a lot of NFS-like tuning possibilities... this is going to escalate quickly now... watch me.... I'm most disappointed by Belgium. People must have known... there is no way man.. I will never understand why I was left with no alternatives to do my initial disclosure back in summer of 2024.. and why I had to face years of unemployment and hopelessness after. But I have a good imagination...and I just know things.. like knowledge just appears in my head out of nowhere.. so I'm pretty sure I know what happened. And Belgium be damned for lacking a spine to stand up against America. Imagine the advantage Europe could have had. Now it is lost forever to speculation. But perhaps everything is happening the way it had to happen. Perhaps I am going to taunt losers like Pete Hegseth, for all the world to see. Come fight me fcking americans. Weaklings. 
