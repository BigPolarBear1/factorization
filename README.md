...
Update: Oh found the issue. Its because for that PoC it loses steam quickly after the first quadratic coefficient, due to the bitlength of the modulus. We should probably overshoot it a little... bit doesn't matter. Let me optimize stuff first tomorrow.
