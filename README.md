...
Update: Wait actually I see how to quickly calculate all permutations of possible coefficients and roots for a given polynomial value. Let me start by writing a function for it, easy enough. its just the divisors of zx+y from which you can calculate all these permutations.
