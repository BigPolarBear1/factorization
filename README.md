...
Update: Fuck it, there is still some bugs in it, but its late and I need to get up early tomorrow. I'll upload it in the coming days. It doesn't matter. A few days more or less. Plus anyone can finish it now... anyway... you need that p-adic lifting.. and upon closer inspection you also need to adjust the bitlength of that modulus, we could reuse generate_modulus() or just use some simpler heuristic (i.e just multiply primes together small to big, nothing fancy)... just so our smooth candidates stay somewhat small. But anyway.. THIS is how you do it. You go looking for a bunch of similar smooths at different quadratic coefficients and BOOM factorization with just a few smooths if you get lucky. And I'm sure there's still plenty of tricks to be found to really speed up this approach. But it's just, you need to think in a 2d way, searching both in the direction of the quadratic coefficient and linear coefficient. Let me see if I can find time tomorrow to iron out those bugs so I can upload atleast a basic version with p-adic lifting.

I guess after this I will spend some time properly understanding ECC. So I can start grinding that problem in the background and leverage everything I have learned so far. ECC. That's where the real damage is to be done. Crypto nazi pieces of shit. Going to make elon musk lose all his money. Haha. Shit for brains nazis. It's time to reclaim technology, because obviously these shit for brains nazis don't deserve it.

Ill upload p-adic lifting early next week. Just tired today. Going to wind down, prepare for tomorrow, another balls to the wall day of running 60k. And I dont feel recovered from running 60k last sunday. Ill go really slow tomorrow to avoid injury i guess.
