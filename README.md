...
Update: Added CRT. Just run on 30-bit for now. Not aiming for speed just yet as there is a few things left to resolve anyway. The distance between values "d" values is determined by the modulus. Let me see if I can either calculate this d value or improve the amount of valid d values further..
