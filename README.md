...
Update: Not quite right what is in the paper. Still one thing missing. Last week when i was adding factors from the ground up.. I see how this works... how I was calculating that k variable in  zx^2-n*k by solving a linear congruence (i.e how many times we had to add N to get divisiblity mod p)... I can see abstractly how I should be incoorporating that into what I'm doing now... let me work it out tomorrow... 

So tomorrow... first thing first.. figure out that shit with that k variable (where z*k is the quadratic coefficient when taking the discriminant)... this dictates wether or not something will be smooth in the integers after combining them with chinese remainder. So that has to be taken into account when performing linear algebra.. I'll go for a run and figure it out tomorrow.

God damnit so close. My brain doesn't work like other people I think. I just see abstractly how things should be working, and it oftens ends up being correct. But it's going from seeing how it should be working abstractly to actually getting it to work which is the infuriating part. Its like walking in the fog, trying to see the landscape... and it sucks to abstractly know the solution already but not yet have the clarity to see it at a granular enough level where you can also achieve it with a proof of concept. Like, it actually makes me severly agitated to the point I find myself wishing to be somewhere alone in a remote part of the world, where there is complete silence so I can find the god damn mental clarity to see beyond the fog. Fuck I'm agitated, I'll go running for real now. I'll finish this tomorrow! I'll see beyond the fog tomorrow!

Update: Let me try and setup linear algebra tomorrow... there is a chance I may be able to fix whats bothering me simply with jacobi symbols now... should be possible hmm. If it works, then thats it.. its over.. within a day I'll have an optmized PoC setting factorization records. I guess this is an interesting way to approach this problem. I also wonder if there is something obvious I missed.. like straight up pulling smooths out of that precalculated hashmap using linear algebra somehow hmm.. something worth exploring if this doesnt work.
