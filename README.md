...
Update: I'll take a break for today. I'll continue tomorrow. I've coded some of the foundations today. Tomorrow I need to figure out how to very quickly iterate root_dist1 and root_dist2 (see construct_interval_2()) for different quadratic coefficients with a single multiplication (or as close as possible). I dont want to construct intervals at all. I just need to find occurances where root_dist1 and root_dist2 drop below a certain bound and save them. Like, that stuff has to go lightning fast. I'll have a first PoC out somewhere this week. I need to finish this project before the end of the year. If I dont succeed before then... I'll have to do 0days agains. 
