...
2^2+4*(4387*4379-35033) = 8758^2</br>
2^2+4*(4387*4379-43790) = 8756^2</br>
2^2+4*(4387*4379-52545) = 8754^2</br>
2^2+4*(4387*4379-61298) = 8752^2</br>
2^2+4*(4387*4379-70049) = 8750^2</br>
2^2+4*(4387*4379-78798) = 8748^2</br>
2^2+4*(4387*4379-87545) = 8746^2</br>
etc..</br></br>

Ofcourse then we would need to find a square such that that offset to N is divisible by N. But that is the same as solving a quadratic congruence, which we cant do without knowledge of the factorization of N and in addition this would basically change that k variable.. aka the quadratic coefficient. </br>
...
UPDATE: EUREKA! I had an insight! I'm attacking this the wrong way. For example:

2^2+4\*(4387\*4379-87545) = 8746^2</br>

Factorizing 2+8746 (2x2x3x3x3x3x3x3x3) and 2-8746 (2x2x2x1093) is going to reveal the factors of 4387\*4379-87545 (2x2x2x3x3x3x3x3x3x3x1093). If we also know the factorization of 87545 then we can trivially turn this into a proper smooth... since this is infact  -87545+4387\*4379. Or -87545\*1^2+4387\*4379 ... so we can set that as quadratic coefficient... and as long as that fully factors, we can transfer those factors to the polynomial value (or transfer squares to the root). I see how I can do it... so the question then is.. I need to sieve such that both squares generated by the discriminant of the full quadratic are small... plus we need to know the full factorization of polynomial output. Then we can turn it into a smooth... and we got ourselves an algorithm. That might actually work.
