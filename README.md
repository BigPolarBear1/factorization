...
Update: Bah, tomorrow my entire day will be gone from running to court ordered therapy (30k to and from) .. because I sent angry emails to the FBI because they are fucking losers and these fucking americans have completely ruined my life. But after that... I'm just going to repurpose generate_modulus() ... just use that to try and get a modulus and root of specific size. Its really just getting a square modulus and root within a certain size range ... thats all that matters. Let me go hard on this after tomorrow. I see the path to finish this now. Just gotta stay focused. 
