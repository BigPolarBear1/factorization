...
Update: Yeap.. I'm certain now, you do need to use p-adic lifting.. there should be an algorithm centered around these residues maps, the way we manipulate that constant in the polynomials and p-adic lifting.. my intuition is screaming at me right now. But I need methodical pen and paper for this last part and peace of mind and I'm too stressed out. I might just take a break for a few days to prepare my trip for Iceland (depending on the health of my father). 
