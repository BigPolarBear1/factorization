...
UPDATE: Trying to think how to best approach this. Rather then shifting smooth candidates... actually... just trying to find smooths with similar factorizations and using square moduli in the initial sieve interval... that should get the bitlength on average of the factors with odd exponents multiplied together just right so I can use it as a modulus for other quadratic coefficients. I experimented with this before in September... but having flattened out these multiples of N now may actually make this much more viable. And using square moduli is also important I think... just to get that bit length of what remains just right so we can use it to create a nice parabola at different quadratic coefficients. Ergh. Should have thought about this earlier. This idea actually makes the most sense. Let me begin working on this ASAP tomorrow.
