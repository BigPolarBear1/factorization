...
def find_comb(n,hmap,primeslist1):
    ...
    construct_interval(ret_array,partials,n,primeslist1,hmap,large_prime_bound)
    return 0
...
def parse_args():
    keysizel,keyl,workersl,debugl,basel,lin_sizel,quad_sizel =0,0,0,0,0,0,0
    ...
    if args.keysize != None:    
        keysizel = args.keysize
    if args.key != None:    
        keyl=args.key
    if args.workers != None:  
        workersl=args.workers
    if args.debug != None:
        debugl=args.debug  
    if args.base != None:
        basel=args.base  
    if args.lin_size != None:
        lin_sizel=args.lin_size  
    if args.quad_size != None:
        quad_sizel=args.quad_size   
    return keysizel,keyl,workersl,debugl,basel,lin_sizel,quad_sizel

if __name__ == "__main__":
    keysizel,keyl,workersl,debugl,basel,lin_sizel,quad_sizel=parse_args()
    print_banner()
    main(keysizel,workersl,debugl,basel,keyl,lin_sizel,quad_sizel)
