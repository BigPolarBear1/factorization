    ...
    for idx in enumerated_product(*enum):
        ...
        while eq2<n:
          ...
          #  print(div/z)
            ...
            while sqrt_start < n and sqrt !=0:# and hit ==1:
                
                factor=gcd(abs(y02+sqrt_start),n)
                if factor != 1 and factor != n:
                    if y02**2%n == sqrt_start**2%n:
                        z2=(y02**2-sqrt_start**2)/n
                        print("y0: "+str(y0)+" x2: "+str(x2)+" eq2**0.5: "+str(eq2**0.5)+" mod: "+str(mod)+" i: "+str(i)+" z: "+str(z)+" eq/mod: "+str(eq/(mod))+" x: "+str(x)+" full eq2: "+str(eq2)+" full eq: "+str(eq))
                        print("Factored N: "+str(factor)+" and: "+str(n//factor)+" y0: "+str(y02)+" y1: "+str(sqrt_start)+" div: "+str(div/z)+" ja: "+str(jacobi(sqrt,z*4*n))+" z/mod: "+str(z2/eq2)+" i: "+str(i))
                ...
                sqrt_start+=sqrt
           # if hit == 1:
            print("y0: "+str(y0)+" x2: "+str(x2)+" eq2: "+str(eq2**0.5)+" mod: "+str(mod)+" i: "+str(i)+" z: "+str(z)+" eq: "+str(eq/(mod))+" x: "+str(x)+" full eq2: "+str(eq2)+" full eq: "+str(eq))
            print("Did not find a factor")#+str(div/z)+" ja: "+str(jacobi(sqrt,z*4*n)))
