           ...
           # factors,rem=factorise_fast(square1,factor_base)
            ...
            if rem2 == 1:
                ...
                while q < len(quad_base):
                    ja_ys=jacobi((y0_squared-n*4*z)%quad_base[q],quad_base[q])
                    if ja_ys == -1:
                         qchar.append(-1)
                    elif ja_ys != 0:
                        ys=tonelli((y0_squared-n*4*z)%quad_base[q],quad_base[q])
            ...
            if bit == 1:
               ...
               # g=gcd(z,mod)
                ...
                if relations[idx]%N != relations2[idx]%N:
                    ...
                    wrap=1
                print("[Debug Info]Adding to left mod N: "+str(relations[idx]%N)+" adding to right mod N: "+str(relations2[idx]%N)+" y0: "+str(colist[idx])+" z: "+str(z_list[idx])+" discriminant: "+str(disc_list[idx])+" qchar: "+str(qchar[idx]))#+" ja:"+str(ja))
