...
###notes: use with python3 polarbearalg_v04.py -key 4387, refer to paper for the math.

####I am working on my own custom number field sieve implementation using reducible quadratic polynomials.

###To do:
#Do not use zx-yx+N but only polynomials of the form zx-yx. We iterate z instead.. will show tomorrow..
