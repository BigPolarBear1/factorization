           ...
           # square2%=mod
            ...
            if rem == 1 and rem2 == 1:
                ...
                if square1 not in ret_array[0]:
                   ...
                   # if abs(square1)**0.5%1 ==0:# and -1 not in zjac:
                    print("[*]Found smooth mod m: y0: "+str(y0)+" square1: "+str(square1)+" square2: "+str(square2)+" qchar: "+str(qchar)+" z: "+str(z)+" mod: "+str(mod))
            i+=1
            ...
            if bit == 1:
              ...
              #  y0sqr*=y0**2
               ...
               # if relations[idx]%N != relations2[idx]%N:
                ...
                print("[Debug Info]Adding to left mod N: "+str(relations[idx]%N)+" adding to right mod N: "+str(relations2[idx]%N)+" y0: "+str(colist[idx])+" z: "+str(z_list[idx])+" discriminant: "+str(disc_list[idx])+" qchar: "+str(qchar[idx])+" mod: "+str(mod_list[idx]))#+" ja:"+str(ja))
    ...
    while z < z_max:
       ...
       # tmod=55
        ...
        if mod ==1:
            ...
            continue
       # if mod == tmod:
          #  print("collected: "+str(collected)+" z: "+str(z))
