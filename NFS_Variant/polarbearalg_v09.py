...
###notes: use with python3 polarbearalg_v08.py -key 4387 (or alternatively with -keysize 14)
          ...
          #  print("vector: ",bit)
            if bit == 1:
               ...
               # g=gcd(z,mod)
                ...
                print("[Debug Info]Adding to left: "+str(relations[idx]%N)+" adding to right: "+str(relations2[idx]%N)+" y0: "+str(colist[idx])+" z: "+str(z_list[idx])+" discriminant: "+str(disc_list[idx])+" qchar: "+str(qchar[idx])+" root: "+str(x)+" eq1: "+str(eq1_full%N))#+" ja:"+str(ja))
