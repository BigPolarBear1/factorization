...
###notes: use with python3 polarbearalg_v01.py -key 4387 -z 1 , refer to paper for the math.
...
def gen_comb(collected,mod,z,n,factor_base):
    enum=[]
    i=0
       ...
       # print("prime: ",old[i])
        ...
        while j < len(old[i+1]):
            if old[i+1][j] < (old[i]//2+1):
              ...
              #  print("co: "+str(old[i+1][j])+" lifted: "+str(lifted_co))
    ...
    while z < z_max:
        ...
        while i < len(hmap):
           ...
           # print("mod: "+str(mod)+" col: "+str(collected))
            ...
            print("mod: "+str(mod**max_exp)+" col: "+str(collected))

            gen_comb(collected,mod**2,z,n,factor_base)
