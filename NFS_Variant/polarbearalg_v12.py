...
###notes: use with python3 polarbearalg_v12.py -keysize 14
...
p_amount=30 #amount of primes in factor base
p_mod_amount=4 #amount of primes in the modulus
...
def extract_factors(N, relations, null_space,relations2,colist,z_list,disc_list,qchar,quad_base,mod):
    ...
    for vector in null_space:
        ...
        print("sqrt_right: ",sqrt_right)
        print("sqrt_left: ",sqrt_left)
