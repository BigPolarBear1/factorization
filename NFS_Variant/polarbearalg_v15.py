...
###notes: use with python3 polarbearalg_v15.py -keysize 14
...
def gen_comb(collected,mod,z,n,factor_base,ret_array,quad_base):
    ...
    for idx in enumerated_product(*enum):
        ...
        while i < 1: 
            ...
            factors2,rem2=factorise_fast(square2_mod,factor_base)
            qchar=[]
            if rem == 1 and rem2 == 1:
                ...
                if square1 not in ret_array[0]:
                 ...
                 #   print("square2_mod: ",square2_mod)
                    ret_array[6].append(square2_mod)#//mod)%mod)
