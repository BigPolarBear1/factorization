            ...
            if local_mod>1:
                ...
                while c < 2:#quad_sieve_size+1:
                    ...
                    while poly_ind < end:
                        ...
                        mod_found,sim_found=process_interval(ret_array,single_interval,n,quad,lin,partials,large_prime_bound,local_primes,threshold_map[i],local_mod,size,mod_found,quad_interval,hmap,indexmap,quad_interval_index,grays,target_main)
...
cdef construct_similar(quad_co,lin,totalmod,n, int [::1] temp,local):
  #  print("quad_co: ",quad_co)
  #  print("lin: ",lin)
  #  print("totalmod: ",totalmod)
  #  print("local",local)
    #TO DO: P-ADIC LIFTING TO FILL OUT THE INTERVAL
...
def find_similar_smooth_2(quad_co,primes,n,hmap,indexmap,indexes,local,ret_array,grays,target_main):
    ...
    while poly_ind < end:
        ...
        poly_ind+=1
        temp = target_main[:]
        construct_similar(quad_co,lin,totalmod,n,temp,local)
        found+=process_similar(temp,lin,quad_co,ret_array,totalmod,local,n)
    return found

def find_similar_smooth(local_factors,lin_co,quad_co,quad_interval,n,hmap,indexmap,quad_interval_index,ret_array,grays,target_main):
    ...
    while i < len(quad_interval):
        ...
        if hit == len(local_factors):
            ...
            sim_found+=find_similar_smooth_2(i+1,local_factors,n,hmap,indexmap,indexes,local,ret_array,grays,target_main)
